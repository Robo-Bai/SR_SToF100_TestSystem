                        ...
                        for num in range(100):
                            if global_value.stop_flag == 0:
                                ...
                                if global_value.stop_flag == 0:
                                    ...
                                    global_value.PDF_normal_num = global_value.normal_num
                                    global_value.PDF_outliers_num = global_value.outliers_num
                                    global_value.outliersRata_flag = global_value.outliersRata_flag + 1

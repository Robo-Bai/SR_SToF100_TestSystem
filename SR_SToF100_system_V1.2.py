# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：SR-SToF100-test-system -> SR_SToF100_system_V1.2
@IDE    ：PyCharm
@Author ：BJW
...
class PDFGenerator:
    ...
    def genTaskPDF(self, home_data, task_data):
        ...
        story.append(Spacer(1, 3 * mm))
        img_uart_path = './Matplot_data/OutliersRate_image.png'
        img_uart = reportImage(img_uart_path)
...
class PDF_result():
    ...
    def pdf_result():
        ...
        # rate = str(((global_value.PDF_outliers_num) / 2) * 100)

# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：SR-SToF100-test-system -> SR_SToF100_system
@IDE    ：PyCharm
@Author ：BJW
                                    ...
                                    if readResult[1].DATA[0] == 0x05:
                                        ...
                                        if distance != 0x96:
                                            ...
                                            if signal_strength > 0x1B58:#信号强度过滤 > 7000
                                                ...
                                                print(global_value.outliers_num)
                        ...
                        for num in range(100):
                            if global_value.stop_flag == 0:
                                ...
                                if global_value.stop_flag == 0:
                                    ...
                                    print('正常点：%s   错误点：%s'%(global_value.PDF_normal_num,global_value.PDF_outliers_num))
                                else:

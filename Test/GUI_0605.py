# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：SR-SToF100-test-system -> GUI_0605
@IDE    ：PyCharm
@Author ：BJW
@Date   ：2021/6/5 9:07
=================================================='''
...
#################################################################################
    ...
    # def ClickedStop_status(self):
    #     '''
    #     单击停止测试按钮后，开始测试、设置初始化位置、三轴回原点按钮不可用
    #     :return:
    #     '''
    #     self.Test_start.setEnabled(False)
    #     self.Location_set.setEnabled(False)
    #     self.Origin_Button.setEnabled(False)
    #
    # def ClickedStop_restatus(self):
    #     '''
    #     等待停止测试完成，开始测试、设置初始化位置、三轴回原点按钮恢复可用
    #     :return:
    #     '''
    #     self.Test_start.setEnabled(True)
    #     self.Location_set.setEnabled(True)

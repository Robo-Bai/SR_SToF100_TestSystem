...
############################################################################################
    ...
    #     self.mutex = QMutex()
    #
    #     self.Begin_Button.clicked.connect(self.__onClickedBtnbegin)
    #     self.Pause_Button.clicked.connect(self.__onClickedBtnpause)
    #     self.Resume_Button.clicked.connect(self.__onClickedBtnresume)
    #     self.Cancel_Button.clicked.connect(self.__onClickedBtncancel)
    #
    # # 暂停
    # def pause(self):
    #     print("线程暂停")
    ...
    # #             time.sleep(1)
    # #
    # #     progress_thread = Thread(target=run,
    # #                              args=())

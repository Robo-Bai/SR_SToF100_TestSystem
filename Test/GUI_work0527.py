# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：SR-SToF100-test-system -> GUI_work0527
@IDE    ：PyCharm
@Author ：BJW
@Date   ：2021/5/27 9:54
=================================================='''
...
class DriveCAN(PCANBasic):
    ...
    def can_read_SH200(self, chanel=PCAN_USBBUS1):  # 默认参数：通道
        ...
        def thread_SH200_DATA_read():
            ...
            Polar_angle = np.linspace((2*np.pi)/7.2, (2*np.pi)/2.769, 330, endpoint=True)
            num = 0
                                    ...
                                    if readResult[1].DATA[0] == 0x05:
                                        ...
                                        if distance != 0x96:
                                            ...
                                            if signal_strength > 0x1388:
                                                fillOperation(Polar_angle[num], distance, signal_strength)

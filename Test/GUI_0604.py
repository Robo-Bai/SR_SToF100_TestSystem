# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：SR-SToF100-test-system -> GUI_0604
@IDE    ：PyCharm
@Author ：BJW
@Date   ：2021/6/4 9:07
=================================================='''
                                    ...
                                    if readResult[1].DATA[0] == 0x05:
                                        ...
                                        if distance != 0x96:
                                            ...
                                            if signal_strength > 0x1B58:#信号强度过滤 > 7000
                                                ...
                                                mainWindow.DataDisplay_Window.textBrowser.append("取点详情：角度 = %.5f 测距 = %s cm 信号强度 = %s"
                                                                                      % (angle_data, distance, signal_strength))
                                            else:
                                                mainWindow.DataDisplay_Window.textBrowser.append("【异常】：信号强度异常")
                                        else:
                                            num = num + 1
                                            print("num = %s" % (num))
                                            fill_strength(num, signal_strength)
                                            mainWindow.DataDisplay_Window.textBrowser.append("【无效】：测距无效（150cm）")
                                    else:
                                        pass
                                else:
                                    pass

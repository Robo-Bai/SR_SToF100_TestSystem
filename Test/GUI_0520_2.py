# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：SR-SToF100-test-system -> GUI_0520_2
@IDE    ：PyCharm
@Author ：BJW
...
########################################################################
    ...
    def Return_Origin_judge(self):
        ...
        # DriveCAN().CAN_read()
        # if X_Origin_flag == 1 and Z_Origin_flag == 1 and R_Origin_flag == 1:
        self.MainUi_textBrowser.append("绿灯闪烁【三次】说明三轴均已经回原点")
